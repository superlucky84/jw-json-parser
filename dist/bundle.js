...
var Parser = exports.Parser = function () {
  function Parser(TEXTAREA) {
    ...
    $root.bind('click', function (event) {
      ...
      if ((0, _jquery2.default)(target).hasClass("toggle") === false && (0, _jquery2.default)(target).hasClass("toggle-end") === false) {
        return;
      }
      if ((0, _jquery2.default)(target).parent("span, div").hasClass("hide")) {
        (0, _jquery2.default)(target).parent("span, div").removeClass("hide");
      } else {
        (0, _jquery2.default)(target).parent("span, div").addClass("hide");
      }
    });
  }
